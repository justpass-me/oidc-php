...
class OpenIDConnectClient
{
     ...
     * @see http://docs.microsoft.com/en-us/azure/active-directory-b2c/user-flow-overview 
     */
    ...
    /**
     * @var bool Enable or disable upgrading to http by paying attention to HTTP header HTTP_UPGRADE_INSECURE_REQUESTS
     */
    protected $httpUpgradeInsecureRequests = true;

    /**
     * @var string holds code challenge method for PKCE mode
     * @see http://tools.ietf.org/html/rfc7636
     */
     ...
     * (Defined in http://tools.ietf.org/html/rfc6749#section-4.3)
     *
     ...
     * http://datatracker.ietf.org/doc/html/rfc8693
     *
     ...
     * @see http://tools.ietf.org/html/rfc7662
     *
     * @param string $token
